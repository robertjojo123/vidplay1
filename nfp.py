# This file is taken from: https://github.com/DownrightNifty/computercraft-stuff
# All credit goes to DownrightNifty
...
CC_COLORS = (
    ...
    (222, 222, 108), # yellow, 3
    (153, 178, 242), # lightblue, 4
    (127, 204, 25),  # lime, 5
    (242, 178, 204), # pink, 6
    (76, 76, 76),    # gray, 7
